<p align="center">
  <img src="assets/bumblebee-icon.png" alt="Bumblebee Bot" width="200">
</p>
...
- **[Admin Console](docs/Admin-Console.md)** — the operator web UI: stack health, `.env` config editor with drift detection, voice table, and a live n8n workflow-trace log
